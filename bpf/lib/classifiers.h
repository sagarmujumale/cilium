...
ctx_device_classifiers(const struct __ctx_buff *ctx)
{
...
#else
#define ctx_device_classifiers(ctx) CLS_FLAG_NONE
#define ctx_device_classifiers4(ctx) CLS_FLAG_NONE
#define ctx_device_classifiers6(ctx) CLS_FLAG_IPV6
...
#else
#define ctx_from_netdev_classifiers(ctx, l4_off, protocol) CLS_FLAG_NONE
